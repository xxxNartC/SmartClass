...
<!-- Form tìm kiếm -->
<form action="chapterlist" method="post" class="search-form">
    <div class="search-container">
        <input type="text" class="form-control" id="search_chapter" name="search_name" placeholder="Search here">
    ...
    <c:forEach items="${listChap}" var="c">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <h3>${c.chapter_name}</h3>

            </div>
            <a href="lesson?chapter_id=${c.chapter_id}" class="inner-button">
...
<div class="pagination">
    <c:forEach begin="1" end="${page}" var="i">
        <a href="chapterlist?index=${i}&search_name=${search_name}"> ${i} </a>
    </c:forEach>
</div>
</body>
</html>
