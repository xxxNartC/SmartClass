    ...
    <c:if test="${sessionScope.user.role_id == '3'}">
        <div class="container">
            <div class="card" style="margin-top: 30px; padding: 20px;">
                <div class="card-body">
                    <h1 class="card-title">Edit Chapter</h1>
                    ...
                    <form action="editChapter" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="chapter_no" name="chapter_no"
                                   value="${chapter_no != null ? chapter_no : chapter.chapter_no}" required>
                            <c:if test="${not empty chapter_no_error}">
                                <small class="text-danger">${chapter_no_error}</small>
                            </c:if>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="chapter_name" name="chapter_name"
                                   value="${chapter_name != null ? chapter_name : chapter.chapter_name}" required>
                            <c:if test="${not empty chapter_name_error}">
                                <small class="text-danger">${chapter_name_error}</small>
                            </c:if>
                        </div>
